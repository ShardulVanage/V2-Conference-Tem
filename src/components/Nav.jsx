...
export function Nav() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-4">
     ...
     <Menu>
      <MenuHandler>
        <Button variant="text">Exhibitors</Button>
      </MenuHandler>
      <MenuList>
        <MenuItem>Exhibitors</MenuItem>
        <MenuItem>Feature Companies</MenuItem>
      ...
      <MenuList>
        ...
        <MenuItem>Disover Budapest</MenuItem>
        <MenuItem>Networking App</MenuItem>
        <MenuItem>ZepResearch Dubai</MenuItem>
        <MenuItem>ZepResearch Asia</MenuItem>
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-1 lg:px-8 ">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
       
        <Typography
          as="a"
          href="#"
          className="mr-4 cursor-pointer text-xs py-1.5 font-medium flex flex-row items-center gap-x-2"
        >
          <img src={zlogo} alt="logo"  className="h-8 w-8 inline-flex rounded-md"/>
           
          <p className="font-semibold">Zep <br /> Research</p>
        </Typography>
        <div className="flex items-center gap-x-1">
        <div className="hidden lg:block px-2 mr-3 ">{navList}</div>
          <Button variant="text" size="sm" className="hidden lg:inline-block drop-shadow-md mr-1 bg-white">
          ...
          color="yellow"
            variant="gradient"
            size="sm"
            className="hidden lg:inline-block drop-shadow-md"
          >
