...
export function CardPass() {
 ...
 <div className="container mx-auto mb-10 text-center lg:mb-20 ">
        ...
        <Typography
          color="blue-gray"
          className="mb-4 !text-2xl font-bold lg:!text-6xl text-gray-900 underline decoration-blue-500 decoration-4 underline-offset-4"
        >
         One Pass. Two Game-Changing Days.
        </Typography>
        <Typography
          variant="lead"
          className="mx-auto max-w-lg !text-gray-800"
        >
          GET ACCESS TO
        </Typography>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {cardData.map((card) => (
          <div key={card.id} className="border border-black/[0.2] flex flex-col  max-w-sm  p-4 relative h-auto drop-shadow-lg bg-white mx-2">
