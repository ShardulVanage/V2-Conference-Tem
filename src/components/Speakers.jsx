    ...
    <div className="bg-white py-24 sm:py-32 ">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Speaker at Zep Research</h2>
        ...
        >
          {people.map((person) => (
            <li key={person.name} className="drop-shadow-md bg-white p-4 rounded-2xl">
              <img className="aspect-[3/2] w-full rounded-2xl object-cover grayscale hover:grayscale-0 transition-all duration-300 ease-in-out" src={person.imageUrl} alt="" />
